...
module.exports.uploadpage = function(req, res) {
    ...
    try {       
        ...
        Filedb.findOne({ id: id }, function(err, result) {
            ...
            // 절대 경로 사용
            dir = path.join('/gamesubmit/nodedev/Unity1', 'public', 'fileStorage', currentYear + '_' + currentSemester, folderName);
...
module.exports.uploadGame = function(req, res) {
    ...
    //console.log('* Request query.year:', req.query.year);
    //console.log('* Request query.semester:', req.query.semester);
    var id = req.params.id;
    var year = req.query.year;
    var semester = req.query.semester;
    dir = path.join('/gamesubmit/nodedev/Unity1', 'public', 'fileStorage', year + '_' + semester, id);
    console.log('dir:', dir);
